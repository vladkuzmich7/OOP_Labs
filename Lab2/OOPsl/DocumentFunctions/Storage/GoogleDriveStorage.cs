...
{
    public class LocalFileStorage1 : IStorageStrategy
    {
        private readonly string documentsFolder = @"G:\Мой диск\folderId";
        private readonly string historyFolder = @"G:\Мой диск\folderId";

        public LocalFileStorage1()
        {
